			...
			<div id="shopping_cart"> 
				...
				<div id="products_box">
					...
					if(isset($_GET['eid'])){
						...
						$get_epiosde= "select * from episode where eid='$eid'";

						$run_episode = mysqli_query($con, $get_epiosde); 
						
						while($row_episode=mysqli_fetch_array($run_episode)){
						
							$eid = $row_episode['eid'];
							$episode_name = $row_episode['episode_name'];
							$episode_no = $row_episode['episode_no'];
							$episode = $row_episode['file'];
								...
								<div style='float:center'>
									...
									<source src='admin/data/$episode' type='video/mp4'>
									</video>
