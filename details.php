			...
			<div id="shopping_cart"> 
				...
				<div id="products_box">
					...
					<?php 
						...
						$get_series = "select * from series where series_id='$series_id'";

						$run_series = mysqli_query($con, $get_series); 
						
						$update_wl = "UPDATE watchlist SET series_id='$series_id' where username='$email'";
						
						$run_update_wl = mysqli_query($con,$update_wl);					
						...
						while($row_series=mysqli_fetch_array($run_series)){
							...
							echo "
									<div style='float:center' id='single_product'>
									
										<h3>$series_title</h3>
										
										<img src='admin/thumbnail/$thumbnail' width='400' height='300' />
										
										
										<p> <font size='5'>$series_desc </font></p>
										
										<a href='season.php?series_id=$series_id'><button style='float:center'>Seasons</button></a>
